...
Users adding custom vocabulary clips place 8 kHz mono 16-bit WAV files in
`user_8k/` (or `/etc/usrp-rc/user_8k/` once installed) — same naming
convention as `vocab_8k/`, and they take priority over the stock clips.
